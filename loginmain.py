...
"}")
        ...
        self.lback = QtWidgets.QFrame(self.backfull)
        self.lback.setGeometry(QtCore.QRect(0, 0, 281, 661))
        ...
        self.gridLayout_3 = QtWidgets.QGridLayout(self.lback)
...
"border:5px solid black}")
        ...
        self.badge.setText("")
        self.badge.setPixmap(QtGui.QPixmap("etro.svg"))
        ...
        self.gridLayout_3.addWidget(self.whitelog, 0, 0, 1, 2, QtCore.Qt.AlignTop)
        ...
        self.insta.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("icaon/soc/instagram (1).png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.insta.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icaon/soc/twitter.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.fb.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icaon/soc/facebook (1).png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fb.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/white/white/activity.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.connect.setIcon(icon4)
        self.connect.setIconSize(QtCore.QSize(24, 24))
        self.connect.setObjectName("connect")
        self.gridLayout_3.addWidget(self.connect, 1, 0, 1, 1)
        self.logdet = QtWidgets.QFrame(self.backfull)
        self.logdet.setGeometry(QtCore.QRect(350, 60, 450, 450))
    ...
    def create_connection(self,host_name,user_name,user_password,db):
        ...
        try:
            ...
            icon5 = QtGui.QIcon()
            icon5.addPixmap(QtGui.QPixmap(":/white/white/check-circle.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
            ...
            icon6 = QtGui.QIcon()
            icon6.addPixmap(QtGui.QPixmap(":/white/white/alert-triangle.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
